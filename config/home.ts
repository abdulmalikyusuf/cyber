import HuaweiEarbuds from "/public/images/banner/huawei-earbuds.png";
import IpadPro from "/public/images/banner/ipad-pro.png";
import MacbookM1 from "/public/images/banner/Macbook 1.png";
import RotatedAppleWatch from "/public/images/banner/rotated-apple-watch.png";
import SamsungGalaxy from "/public/images/banner/samsung-galaxy.png";
...
export const categories = [
	{ title: "Phones", icon: "/svg/categories/phone.svg" },
	{ title: "Smart Watches", icon: "/svg/categories/smartwatches.svg" },
	{ title: "Camera", icon: "/svg/categories/Cameras.svg" },
	{ title: "Headphones", icon: "/svg/categories/Headphones.svg" },
	{ title: "Computers", icon: "/svg/categories/Computers.svg" },
	{ title: "Gaming", icon: "/svg/categories/Gaming.svg" },
];
...
export const banner = [
	{
		...
		img: [HuaweiEarbuds, RotatedAppleWatch],
	},
	{
		title: "Ipad Pro",
		description:
